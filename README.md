...
## Inferencia de queda em camera

A arquitetura inicial para inferencia continua com video local, webcam ou camera RTSP/IP
esta documentada em [`docs/fall_detection.md`](docs/fall_detection.md).
